                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="border border-[#27272a] bg-[#0f0f11] p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    <label className="block text-xs font-mono text-zinc-500 mb-1 uppercase">Potência Usada (W)</label>
                                    <input type="number" 
                                ...
                                {data.filaments.map((f, idx) => (
                                    <div key={idx} className="flex gap-4 items-end bg-[#09090b] p-3 border border-[#27272a]">
                                        <div className="flex-1">
                                            ...
                                            <select 
                                                className="w-full bg-transparent border-b border-zinc-800 text-white py-2 focus:border-[#CCFF00] focus:ring-0 outline-none"
                ...
                <div className="w-full lg:w-[30%] xl:w-[25%] sticky top-8">
                    <div className="border border-[#27272a] bg-[#CCFF00] text-black p-6 shadow-[8px_8px_0px_#000]">
                        ...
                        <div className="space-y-3 font-mono text-sm">
                            ...
                            <div className="pt-6 mt-4 border-t-2 border-black flex flex-col items-center">
                                <span className="text-xs uppercase tracking-widest opacity-70 mb-1">TOTAL PREVISTO</span>
                                <span className="text-3xl font-bold tracking-tighter">R$ {previewCalculations.final.toFixed(2)}</span>
                            </div>
                        </div>
                    </div>
                </div>
